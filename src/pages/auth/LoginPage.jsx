    ...
    <div className="min-h-[calc(100dvh-64px)] flex items-center justify-center bg-surface px-4 py-8 sm:py-12 pb-[max(2rem,env(safe-area-inset-bottom,0px))]">
      <div className="bg-white border border-border rounded-2xl p-5 sm:p-8 w-full max-w-md shadow-card">
        <div className="text-center mb-8">
          ...
          <p className="text-text-muted">Sign in to your THREVOLT account</p>
        </div>
          ...
          <>
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-white px-3 text-text-muted font-medium">or sign in with email</span>
              </div>
            </div>
          </>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col gap-1">
            <label htmlFor="login-email" className="text-xs font-bold text-text-muted uppercase tracking-wider">Email</label>
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-center justify-between">
              <label htmlFor="login-password" className="text-xs font-bold text-text-muted uppercase tracking-wider">Password</label>
        ...
        <p className="text-center mt-6 text-sm text-text-muted">Don't have an account? <Link to="/register" className="font-bold text-primary hover:text-primary-dark transition-colors">Sign up</Link></p>
      </div>
    </div>
  );
}
