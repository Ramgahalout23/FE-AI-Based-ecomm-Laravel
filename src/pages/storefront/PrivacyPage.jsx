    ...
    return (
      <div className="flex-1 bg-surface flex items-center justify-center min-h-[50vh]">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-800 mb-2">{t('privacy.page_not_available')}</h2>
          <p className="text-gray-500 mb-4">{error || t('privacy.content_not_found')}</p>
    ...
    <div className="page-content bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {content.content ? (
          ...
          <p className="text-gray-600">{t('privacy.no_content')}</p>
        )}
      </div>
    </div>
  );
