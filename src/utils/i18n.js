...
const DEFAULT_EN_TRANSLATIONS = {
  ...
  'auth.verification_needed': 'One more step: verify your account',
  'auth.verify_your_account': 'Verify your account',
  'auth.otp_sent_sms': 'We sent a 6-digit code to {{destination}}. Enter it below to activate your account.',
  'auth.otp_sent_email': 'We sent a 6-digit code to {{destination}}. Enter it below or click the link in the email.',
  'auth.otp_digit': 'Digit',
  'auth.verifying': 'Verifying...',
  'auth.verify_and_activate': 'Verify & activate account',
  'auth.invalid_verification_code': 'That code is invalid or expired. Try again or resend.',
  'auth.account_verified': 'Account activated',
  'auth.account_verified_sub': 'Your account is verified. Taking you to the store…',
  'auth.didnt_receive_code': "Didn't get the code?",
  'auth.resend_code': 'Resend code',
  'auth.resend_in': 'Resend in {{seconds}}s',
  'auth.verification_resent': 'A new code is on its way',
  'auth.verify_missing_email': 'Enter your email first',
  'auth.checking': 'Checking…',
  'auth.verify_first': 'Verify your account to continue — we sent you a code',
  'auth.wrong_account': 'Wrong account?',
  ...
  'checkout.min_chars': '(min. 6 chars)',
