...
export const authAPI = {
  ...
  verifyRegistration: (data) => client.post('/auth/verify-registration', data),
  resendRegistrationVerification: (data) => client.post('/auth/resend-registration-verification', data),
  registrationVerificationStatus: (data) => client.post('/auth/registration-verification-status', data),
