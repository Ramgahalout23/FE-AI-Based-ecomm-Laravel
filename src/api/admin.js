...
export const adminAPI = {
  ...
  resetStaffPassword: (id, password) => adminClient.post(`/admin/staff/${id}/password`, { password }),
  ...
  // Security Center
  getSecurityMetrics: () => adminClient.get('/admin/security/metrics'),
  ...
  getSecurityPolicies: () => adminClient.get('/admin/security/policies'),
